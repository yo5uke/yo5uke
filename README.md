...
![Quarto](https://img.shields.io/badge/Quarto-4051B5?style=for-the-badge&logo=quarto&logoColor=white)
...
**[coresynth](https://github.com/yo5uke/coresynth)**

⚡ SCM・SDID・GSC・MC・TASC・SI ── Synthetic Control 系の因果推論手法を単一のフォーミュラインターフェースで実行できるRパッケージ

[![CRAN](https://www.r-pkg.org/badges/version/coresynth)](https://CRAN.R-project.org/package=coresynth)
[![Stars](https://img.shields.io/github/stars/yo5uke/coresynth?style=flat-square&color=yellow&label=%E2%98%85)](https://github.com/yo5uke/coresynth/stargazers)
...
**[hakuchizu_japan](https://github.com/yo5uke/hakuchizu_japan)**

🗺️ 日本全国の都道府県・市区町村をハイライト表示できる白地図Webアプリ  
🔗 [Demo](https://yo5uke.shinyapps.io/hakuchizu_japan/)

</td>
<td width="50%" valign="top">

**[population_heatmap](https://github.com/yo5uke/population_heatmap)**

🏙️ 国勢調査データをもとに、総人口・年齢構成・増加率を地図上に可視化するアプリ  
🔗 [Demo](https://yo5uke.shinyapps.io/japan_population_heatmap/)
...
**[subkan](https://github.com/yo5uke/subkan)**

💳 サブスクの料金・支払日・支払いカードをまとめて管理する Material Design 3 準拠のAndroidアプリ
...
**[econ-a4](https://github.com/yo5uke/econ-a4)**

📄 経済学の英語論文を書くためのTypst（Quarto）テンプレート

</td>
<td width="50%" valign="top">

**[rss-paper-digest](https://github.com/yo5uke/rss-paper-digest)**

🤖 RSSフィードから論文を自動取得し、Claude APIで関連度スコアリング・日本語要約を行うツール
